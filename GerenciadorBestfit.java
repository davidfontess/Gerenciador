...
public class GerenciadorBestfit {
    ...
    public GerenciadorBestfit(int tamanhoUnidadeAlocacao, int tamanhoMemoria) {
    ...
    public int buscaSegmento(int comprimento) {
        ...
        for (int a = 0; a < listaEncadeada.size(); a++) {
            if (!listaEncadeada.get(a).isOcupado() && listaEncadeada.get(a).getComprimento() >= comprimento) {
                int diferenca = listaEncadeada.get(a).getComprimento() - comprimento;
    ...
    public static void main(String[] args) {
        ...
        GerenciadorBestfit gerenciador = new GerenciadorBestfit(2, 62);
