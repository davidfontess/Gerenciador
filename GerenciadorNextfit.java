...
public class GerenciadorNextfit {
    ...
    public GerenciadorNextfit(int tamanhoUnidadeAlocacao, int tamanhoMemoria) {
  ...
  //Toda vez que um segmento � inserido na lista, o �ndice dos segmentos armazenados na lista precisa ser atualizada  
    ...
    public static void main(String[] args) {
        ...
        GerenciadorNextfit gerenciador = new GerenciadorNextfit(2, 62);
